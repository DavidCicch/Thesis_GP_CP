...
class Matern32_CP(jk.base.AbstractKernel):
    ...
    def check_side_mult(self, x_, y_, params: Dict):
        ...
        def returnxcp(xcp, params, x_, y_):
            ...
            cov = params["variance"]* (1.0 + jnp.sqrt(3.0) * jnp.abs(x_ - y_)/params['lengthscale']) * jnp.exp(-jnp.sqrt(3.0) * jnp.abs(x_ - y_)/params['lengthscale'])
            return cov.squeeze()
